...
export const contacts: Contact[] = [
  ...
  },
  {
    ...
    name: "Health and Counselling Services",
    methods: [
      { type: "email", value: "uhcs@northeastern.edu" },
      { type: "phone", value: "6173732772" },
      { type: "address", value: "Forsyth Building, 1st Floor, 70 Forsyth Street" },
      { type: "website", value: "https://www.northeastern.edu/uhcs/" },
    ],
  },
];
